...
<div id="second">
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="active"><a href="#B" role="tab" data-toggle="tab">每日收支管理</a></li>
    ...
    <div class="tab-pane active" id="A">
        <div id="third">
            <ul class="nav nav-pills">
                <li role="presentation" class="active"><a href="#">每日收入管理</a></li>
                <li role="presentation"><a href="#">每日支出管理</a></li>
            </ul>
        </div>
    </div>
</div>
