...
public class station_day_input {
    ...
    public int getTransaciton_type() {
        return transaciton_type;
    }

    public void setTransaciton_type(int transaction_type) {
        this.transaciton_type = transaction_type;
    }
